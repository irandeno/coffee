...
/* coffee configurations can be forced and overwrited in process args,
...
let username: number = coffee.get("username").number(); // something, readed from process arguments
